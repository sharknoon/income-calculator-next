...
export function ComponentCard({ component }: ComponentCardProps) {
  ...
  return (
    <Card>
      ...
      <CardContent>
        <p className="text-sm text-muted-foreground">{component.description || "No description provided"}</p>
        <div className="mt-2">
          <p className="text-sm">
            <span className="font-medium">Inputs:</span> {component.periods[0]?.inputs.length || 0}
          </p>
          <p className="text-sm">
            <span className="font-medium">Dependencies:</span> {component.periods[0]?.dependencies.length || 0}
          </p>
        </div>
      </CardContent>
